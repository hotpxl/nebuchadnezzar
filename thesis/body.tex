...
和经典的完全理性模型相不同，许多新的行为模型试图合理解释发生的这些剧烈波动。 De Long 等人 \cite{intro:5} 形式化描述了非完全理性交易者，即噪声交易者在市场中扮演的角色。在他们的模型中，有两类投资者：理性套利者和噪声交易者。理性套利者对资产的未来回报持有理性分析，而噪声交易者受外在情感驱动，产生相对于理性分析要么过于乐观要么过于悲观的期待。最终平衡的市场价格反应理性套利者和噪声交易者双方的期待。本质上， De Long 等人 \cite{intro:5} 证明了市场价格因为不理性的乐观情绪或者悲观情绪会偏离价值，证明了噪声交易者在交易中起到的作用。
...
\begin{figure}
  \centering
  \includegraphics[width=0.9\textwidth]{plots/click_count_volume_granger_causality_test_on_sse_50_abnormal.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.9\textwidth]{plots/click_count_volume_granger_causality_test_on_sse_50_abnormal_line.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.9\textwidth]{plots/click_count_volume_line_to_forecast.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.9\textwidth]{plots/click_count_step_5_forecast_volume.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.9\textwidth]{plots/click_count_volume_sliding_ratio_line.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.9\textwidth]{plots/click_count_forecast_volume_sliding_ratio.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.9\textwidth]{plots/sliding_ratio_window_selection_on_sse_50.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.9\textwidth]{plots/click_count_price_line.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.9\textwidth]{plots/click_count_price_granger_causality_test_on_sse_50_lrtest.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.9\textwidth]{plots/click_count_price_granger_causality_test_on_sse_50_params_ftest.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.9\textwidth]{plots/click_count_price_granger_causality_test_on_sse_50_ssr_chi2test.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.9\textwidth]{plots/click_count_price_granger_causality_test_on_sse_50_ssr_ftest.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.9\textwidth]{plots/positive_click_count_price_line.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.9\textwidth]{plots/positive_click_count_price_granger_causality_test_on_sse_50_lrtest.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.9\textwidth]{plots/positive_click_count_price_granger_causality_test_on_sse_50_params_ftest.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.9\textwidth]{plots/positive_click_count_price_granger_causality_test_on_sse_50_ssr_chi2test.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.9\textwidth]{plots/positive_click_count_price_granger_causality_test_on_sse_50_ssr_ftest.pdf}
